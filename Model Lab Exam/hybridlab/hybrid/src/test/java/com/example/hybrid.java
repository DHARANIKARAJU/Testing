...
public class hybrid {
 WebDriver driver;
   ...
   @BeforeTest
    ...
    {
        ExtentSparkReporter exsprk = new ExtentSparkReporter("C:\\Users\\DHARANIKA\\Downloads\\demo\\que 9\\hybridlab\\report1.html");
        reports = new ExtentReports();
        reports.attachReporter(exsprk);
        test = reports.createTest("Test 1", "Add to Cart");
        PropertyConfigurator.configure("C:\\Users\\DHARANIKA\\Downloads\\demo\\que 9\\hybridlab\\hybrid\\src\\main\\resources\\log4j.properties");

        FileInputStream fs = new FileInputStream("C:\\Users\\DHARANIKA\\Downloads\\demo\\que 9\\hybridlab\\data.xlsx");
    ...
    public void afterTest(ITestResult result) throws Exception{
        if(result.getStatus()==ITestResult.FAILURE)
        {
            ...
            String path = "\"C:\\Users\\DHARANIKA\\Downloads\\demo\\que 9\\hybridlab\\"+result.getName()+".png";
