...
public class Barnesnoble {
   ...
   final Logger lobj = Logger.getLogger(getClass());
    ...
    public void setup()
    {
        ExtentSparkReporter sparkReporter = new ExtentSparkReporter("C:\\Software Testing\\cc2\\report.html");
    ...
    {
        PropertyConfigurator.configure("C:\\Software Testing\\cc2\\src\\main\\resources\\log4j2.properties");
    ...
    {  
        FileInputStream fs=new FileInputStream("C:\\Software Testing\\cc2\\ccexcel.xlsx");
    ...
    public void tearDown(ITestResult result)throws Exception
    {
        if(result.getStatus()==ITestResult.FAILURE)
        {
            ...
            String screenShotPath = "C:\\Software Testing\\cc2\\cclogandreport\\"+result.getName()+".png";
